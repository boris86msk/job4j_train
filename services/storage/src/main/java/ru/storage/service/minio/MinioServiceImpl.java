...
public class MinioServiceImpl implements MinioService {
    ...
    /**
     * bucket - имя бакета, в который загружается файл (берётся из конфигурации)
     * object - имя объекта в хранилище
     * stream - поток файла, его размер и -1 как неизвестное значение части потока
